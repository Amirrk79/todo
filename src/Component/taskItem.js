...
function TaskItem({ task }) {
    ...
    return(
        <div>
            {Completed ? 
            <div>
                <h3>Completed Task: </h3> <button class='btn btn-success' onClick={handleComplete}>Not Completed</button>
                </div>
                 : 
                <div>
                    <h3>Not Completed Task: </h3><button class="btn btn-danger" onClick={handleComplete}>Completed</button>
                    </div>}
